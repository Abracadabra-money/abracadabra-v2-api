export const mainnetStrategyLpStrategy = [
    {
        inputs: [
    ...
    },
    {
        inputs: [],
        name: 'staking',
        outputs: [{ internalType: 'contract ILPStaking', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
        inputs: [],
        name: 'stargateToken',
        outputs: [{ internalType: 'contract IStargateToken', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
